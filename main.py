...
async def stream_llm_response(websocket: WebSocket):
    ...
    dump_text = "That is an excellent question. I'm glad you asked. Here is the information you requested. "
    for key, value in item_data.items():
        dump_text += f"You sent the key {key} and the value is {value}. "

    dump_text += "Do you know my good friends lorem and ipsum? Here is their story."
